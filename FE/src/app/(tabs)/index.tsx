...
export default function HomeScreen() {
  ...
  const [activeVideo, setActiveVideo] = useState<{ bunnyVideoId: string; bunnyLibraryId?: string; hlsUrl?: string; title: string } | null>(null);
  ...
  const handlePlayDemoVideo = useCallback((content: any) => {
    if (content.bunnyVideoId) {
      setActiveVideo({ bunnyVideoId: content.bunnyVideoId, hlsUrl: content.hlsUrl, title: content.title });
    } else {
